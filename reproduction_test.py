...
if __name__ == "__main__":
    ...
    if config['std']:
        csv_name = os.path.join(repro_dir, '{}_best_{}_{}_std_-dEST_{}.csv'.format(config['task_name'],  config['model_type'], "-".join(config['rxn_type']), current_time))
    else:
        csv_name = os.path.join(repro_dir, '{}_best_{}_{}_{}.csv'.format(config['task_name'],  config['model_type'], "-".join(config['rxn_type']), current_time))
